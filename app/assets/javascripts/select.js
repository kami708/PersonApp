...
// -----------------------カテゴリ選択ビルド-----------------------
  ...
  function appendChidrenBox(insertHTML){
    ...
    childSelectHtml =`<div class="select-wrap", id="children_wrapper">
                        <select class="select-default" id="child_category" name="product[category_id]"><option value="---">---</option>
                          ${insertHTML}
                        </select>
                      </div>`;
  ...
  function appendGrandchidrenBox(insertHTML){
    ...
    grandchildSelectHtml =`<div class="select-wrap", id="grandchildren_wrapper">
                        <select class="select-default" id="grandchild_category" name="product[category_id]"><option value="---">---</option>
                          ${insertHTML}
                        </select>
                      </div>`;
  ...
  function appendSizeBox(insertHTML){
    ...
    sizeSelectHtml = `<div class="form-group" id="size_wrapper">
                        ...
                        <div class="select-wrap">
                          <select class="select-default" name="product[size_id]" id="size"><option value="---">---</option>
                            ${insertHTML}
                          </select>
                        </div>
                      </div>`;
...
function appendBrandBox(){
    var brandBoxHtml = `<div class="form-group" id="brand_wrapper">
                          ...
                          <div class="select-wrap">
                            <input class="input-brand" value="" placeholder="例）シャネル" type="text" name="product[brand_name]" >
                          </div>
                      </div>`;
    return brandBoxHtml;
  }
  ...
  function appendhiddenBrand(brandId,brandName){
    var html = `<select class="display-none" name="product[brand_id]" id="selected_brand_id">
